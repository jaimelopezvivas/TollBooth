...
namespace TollBooth
{
    public class SendToEventGrid
    {
        ...
        public async Task SendLicensePlateData(LicensePlateData data)
        {
            ...
            {
                // RESOLVE TODO 3: Modify send method to include the proper eventType name value for saving plate data.
                await Send("savePlateData", "TollBooth/CustomerService", data);
            }
            else
            {
                // RESOLVE TODO 4: Modify send method to include the proper eventType name value for queuing plate for manual review.
